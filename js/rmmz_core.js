...
Reflect.set(globalThis, "Point", PIXI.Point);
Reflect.set(globalThis, "Rectangle", PIXI.Rectangle);
//-----------------------------------------------------------------------------
/**
 ...
 * @extends PIXI.Sprite
 */
class ScreenSprite extends PIXI.Sprite {
    constructor() {
        super(PIXI.Texture.EMPTY);
        this.initialize();
    }
    initialize() {
        ...
        this.texture = new PIXI.Texture(this.bitmap._baseTexture);
        this.setBlack();
    }
    /**
    ...
    setColor(r, g, b) {
        if (this._red !== r || this._green !== g || this._blue !== b) {
            ...
            bitmap.fillRect(0, 0, Graphics.width, Graphics.height, color);
        }
    }
}
/**
...
class ColorFilter extends PIXI.Filter {
    ...
    constructor() {
        ...
        super(null, ColorFilter._fragmentSrc, uniforms);
    }
    /**
     * Sets the hue rotation value.
     *
